...
customer_rollup as (
    select
        ...
        sum(cast(promo_item_count > 0 as int64)) as orders_with_any_promo_item,
        sum(cast(promo_item_count = 0 as int64)) as orders_with_no_promo_items,
...
select
    ...
    orders_with_any_promo_item,
    orders_with_no_promo_items,
    promo_item_count,
