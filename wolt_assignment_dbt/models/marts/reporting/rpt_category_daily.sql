...
order_daily as (
    select
        o.order_date,
        oi.item_category,
        count(distinct case when o.is_first_order_for_customer then o.customer_sk end) as category_attributed_first_time_customers,
        count(distinct case when not o.is_first_order_for_customer then o.customer_sk end) as category_attributed_repeat_customers,
        avg(o.delivery_distance_line_meters) as avg_delivery_distance_meters,
        avg(o.total_item_count) as avg_total_items_per_order_for_orders_with_category
...
select
    ...
    i.orders,
    i.customers,
    coalesce(o.category_attributed_first_time_customers, 0) as category_attributed_first_time_customers,
    coalesce(o.category_attributed_repeat_customers, 0) as category_attributed_repeat_customers,
    i.items_sold,
    i.promo_items_sold,
    i.line_revenue_eur,
    i.discount_eur,
    i.avg_selling_price_eur,
    o.avg_total_items_per_order_for_orders_with_category,
